...
export function rotatePoint(pointA: Point, pointB: Point, theta: number): Point {
...
export function spline(P0: Point, P1: Point, P2: Point, P3: Point, percent: number): Point {
